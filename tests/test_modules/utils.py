...
AUTH_TOKEN_V_2_3_0 = str(uuid4())
AUTH_TOKEN_A_V_2_3_0 = str(uuid4())
RANDOM_AUTH_TOKEN_V_2_3_0 = str(uuid4())
...
ENCODED_AUTH_TOKEN_V_2_3_0 = encode_string_base64(AUTH_TOKEN_V_2_3_0)
ENCODED_AUTH_TOKEN_A_V_2_3_0 = encode_string_base64(AUTH_TOKEN_A_V_2_3_0)
ENCODED_RANDOM_AUTH_TOKEN_V_2_3_0 = encode_string_base64(RANDOM_AUTH_TOKEN_V_2_3_0)
...
class ClientAuthenticator(Authenticator):
    ...
    async def get_valid_token_c(cls):
        ...
        return [AUTH_TOKEN, AUTH_TOKEN_V_2_2_1, AUTH_TOKEN_V_2_3_0]

    @classmethod
    async def get_valid_token_a(cls):
        """Return a list of valid tokens."""
        return [AUTH_TOKEN_A, AUTH_TOKEN_A_V_2_2_1, AUTH_TOKEN_A_V_2_3_0]
