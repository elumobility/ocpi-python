...
def test_cpo_get_tariffs_not_authenticated(client_cpo_v_2_1_1):
...
def test_cpo_get_tariffs_v_2_1_1(client_cpo_v_2_1_1):
    response = client_cpo_v_2_1_1.get(GET_TARIFFS_URL, headers=AUTH_HEADERS)
