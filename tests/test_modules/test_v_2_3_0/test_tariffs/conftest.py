...
@pytest.fixture
def client_cpo_v_2_3_0(tariff_cpo_v_2_3_0):
    return TestClient(tariff_cpo_v_2_3_0)


@pytest.fixture
def client_emsp_v_2_3_0(tariff_emsp_v_2_3_0):
    return TestClient(tariff_emsp_v_2_3_0)
