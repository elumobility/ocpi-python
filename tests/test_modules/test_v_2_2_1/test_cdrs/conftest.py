...
@pytest.fixture
def client_cpo_v_2_2_1(cdr_cpo_v_2_2_1):
    return TestClient(cdr_cpo_v_2_2_1)


@pytest.fixture
def client_emsp_v_2_2_1(cdr_emsp_v_2_2_1):
    return TestClient(cdr_emsp_v_2_2_1)
