...
from py_ocpi.core.data_types import CiString, DateTime, DisplayText, String
from py_ocpi.modules.sessions.v_2_3_0.enums import ProfileType
from py_ocpi.modules.tokens.v_2_3_0.enums import (
    AllowedType,
    TokenType,
    WhitelistType,
)
...
class EnergyContract(BaseModel):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tokens.asciidoc#142-energycontract-class
    """
...
class LocationReference(BaseModel):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tokens.asciidoc#143-locationreferences-class
    """
...
class Token(BaseModel):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tokens.asciidoc#132-token-object
    """
...
class AuthorizationInfo(BaseModel):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tokens.asciidoc#131-authorizationinfo-object
    """
