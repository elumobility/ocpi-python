...
class AllowedType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tokens.asciidoc#141-allowedtype-enum
    """
...
class TokenType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tokens.asciidoc#144-tokentype-enum
    """
...
class WhitelistType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tokens.asciidoc#145-whitelisttype-enum
    """
