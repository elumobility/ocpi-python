...
from py_ocpi.modules.commands.v_2_3_0.enums import CommandType
from py_ocpi.modules.commands.v_2_3_0.schemas import (
    CancelReservation,
    ReserveNow,
    StartSession,
    StopSession,
...
async def send_command_result(
    ...
    if not command_result:
        ...
        command_result = adapter.command_result_adapter(
            command_result, VersionNumber.v_2_3_0
        )
