...
class CommandResponseType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_commands.asciidoc#141-commandresponsetype-enum
    """
...
class CommandResultType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_commands.asciidoc#142-commandresulttype-enum
    """
    ...
    # EVSE is currently occupied, another session is ongoing.
    ...
    rejected = "REJECTED"
    # Command request timeout, no response received
    # from the Charge Point in a reasonable time.
    timeout = "TIMEOUT"
    # The Reservation in the requested command
    # is not known by this Charge Point.
    unknown_reservation = "UNKNOWN_RESERVATION"


class CommandType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_commands.asciidoc#143-commandtype-enum
    """

    # Request the Charge Point to cancel a specific reservation.
    cancel_reservation = "CANCEL_RESERVATION"
    # Request the Charge Point to reserve a (specific)
    # EVSE for a Token for a certain time, starting now.
    reserve_now = "RESERVE_NOW"
    # Request the Charge Point to start a transaction on the given
    # EVSE/Connector.
