...
from py_ocpi.modules.sessions.v_2_3_0.schemas import (
...
async def get_session(
    ...
    **Raises:**
    ...
    if data:
        return OCPIResponse(
            data=[adapter.session_adapter(data, VersionNumber.v_2_3_0).model_dump()],
...
async def partial_update_session(
    ...
    **Raises:**
    ...
    if old_data:
        old_session = adapter.session_adapter(old_data, VersionNumber.v_2_3_0)
