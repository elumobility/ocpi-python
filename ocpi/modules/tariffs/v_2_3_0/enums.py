from ocpi.modules.tariffs.enums import *  # noqa


class ReservationRestrictionType(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tariffs.asciidoc#143-reservationrestrictiontype-enum
    """
    ...
    # (i.e. driver does not start a charging session before
    # expiry_date of the reservation).
    reservation_expires = "RESERVATION_EXPIRES"


class TariffDimensionType(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tariffs.asciidoc#145-tariffdimensiontype-enum
    """
    ...
    # Can also be used in combination with a RESERVATION
    # restriction to describe the price of the reservation time.
    time = "TIME"


class TariffType(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_tariffs.asciidoc#147-tarifftype-enum
    """

    # Used to describe that a Tariff is valid when ad-hoc payment is used
    # at the Charge Point
    ...
    # Used to describe that a Tariff is valid when using an RFID,
    # without any Charging Preference,
