...
from ocpi.modules.locations.enums import *  # noqa


class ParkingType(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_locations.asciidoc#1418-parkingtype-enum
    """
...
class Facility(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_locations.asciidoc#1412-facility-enum
    """
...
class Capability(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_locations.asciidoc#143-capability-enum
    """
...
class ConnectorType(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_locations.asciidoc#145-connectortype-enum
    """
...
class PowerType(str, Enum):  # noqa
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_locations.asciidoc#1419-powertype-enum
    """
...
class VehicleType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/release-2.3.0-bugfixes/mod_locations.asciidoc#vehicletype-openenum
    New in OCPI 2.3.0 - Vehicle type categorization for parking spaces.
    """
    ...
    personal_vehicle_with_trailer = "PERSONAL_VEHICLE_WITH_TRAILER"
...
class ParkingDirection(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/release-2.3.0-bugfixes/mod_locations.asciidoc#parkingdirection-enum
    New in OCPI 2.3.0 - Direction in which parking occurs relative to the roadway.
    """
...
class EVSEPosition(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/release-2.3.0-bugfixes/mod_locations.asciidoc#evseposition-enum
    New in OCPI 2.3.0 - Position of an EVSE relative to the parking space.
    """

    # The EVSE is to the left of the vehicle
    left = "LEFT"
    # The EVSE is to the right of the vehicle
    right = "RIGHT"
    # The EVSE is in front of the vehicle
    front = "FRONT"
    # The EVSE is behind the vehicle
    rear = "REAR"
