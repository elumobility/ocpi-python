...
from ocpi.modules.credentials.v_2_1_1.schemas import Credentials
...
async def get_credentials(
    ...
    **Returns:**
    ...
    return OCPIResponse(
        data=adapter.credentials_adapter(data, VersionNumber.v_2_1_1).model_dump(),
...
async def post_credentials(
    ...
    **Raises:**
        HTTPException: If the client is already registered
            (HTTP 405 Method Not Allowed) or if the token is not valid
