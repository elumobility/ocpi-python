...
class ChargingPreferencesResponse(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_sessions.asciidoc#141-chargingpreferencesresponse-enum
    """

    # Charging Preferences accepted, EVSE will try to accomplish them,
    # although this is no guarantee that they will be fulfilled.
    accepted = "ACCEPTED"
    # CPO requires departure_time to be able to perform
    # Charging Preference based Smart Charging.
    departure_required = "DEPARTURE_REQUIRED"
    # CPO requires energy_need to be able to perform
    # Charging Preference based Smart Charging.
    energy_need_required = "ENERGY_NEED_REQUIRED"
    # Charging Preferences contain a demand that
    # the EVSE knows it cannot fulfill.
...
class ProfileType(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_sessions.asciidoc#142-profiletype-enum
    """
    ...
    fast = "FAST"
    # Driver wants his EV charged with as much regenerative
...
class SessionStatus(str, Enum):
    """
    https://github.com/ocpi/ocpi/blob/2.3.0/mod_sessions.asciidoc#143-sessionstatus-enum
    """

    # The session has been accepted and is active.
    # All pre-conditions were met: Communication between EV and EVSE
    # (for example: cable plugged in correctly),
    ...
    completed = "COMPLETED"
    # The Session object using this state is declared invalid
    # and will not be billed.
    invalid = "INVALID"
    # The session is pending, it has not yet started.
    # Not all pre-conditions are met.
