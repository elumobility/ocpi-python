"""
OCPI status codes based on
https://github.com/ocpi/ocpi/blob/2.2.1/status_codes.asciidoc
"""
...
OCPI_3003_NO_MATCHING_ENDPOINT = {
    "status_code": 3003,
    "status_message": "No matching endpoints or "
    "expected endpoints missing between parties",
}
...
OCPI_4002_TIMEOUT_ON_FORWARDED_REQUEST = {
    "status_code": 4002,
    "status_message": "Timeout on forwarded request "
